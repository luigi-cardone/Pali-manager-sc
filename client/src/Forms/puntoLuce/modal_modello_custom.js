...
export const ModalSezioneCustom = (props) => {
    ...
    const handleSubmit = (e) =>{
        e.preventDefault()
        props.setPlData({...props.plData, verifica_strutturale: {...props.plData.verifica_strutturale, [props.data.nome_sezione ? props.data.nome_sezione.toLowerCase().replaceAll(" ", "_") : data["nome_sezione"].toLowerCase().replaceAll(" ", "_")]: data}})
        props.onClose()
    }
