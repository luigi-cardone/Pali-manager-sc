...
export const ModalSezioneBase = (props) => {
    ...
    const formData = [
        [
            {
                type: "title",
                label: "Tronco e flangia di base"
            }
        ],
        [
            {
        ...
        [
            {
                type: "sub_title",
                label: "Saldature Longitudinali e Circonferenziali e tirafondi"
            }
        ],
        [
            {
    ...
    const handleSubmit = (e) =>{
        e.preventDefault()
        props.setPlData({...props.plData, verifica_strutturale: {...props.plData.verifica_strutturale, sezione_base: data}})
        props.onClose()
    }
